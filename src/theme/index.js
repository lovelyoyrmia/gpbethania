export default {
  ...
  colors: {
    text: "#1e81b0", // body color and primary color
    text_secondary: "#02073E", // secondary body color
    heading: "#02073E", // primary heading color
    heading_secondary: "#1e81b0", // heading color
    background: "#FFFFFF", // body background color
    background_secondary: "#F9FBFD", // secondary background color
    border_color: "#E9EDF5", // border color
    primary: "#1e81b0", // primary button and link color
    secondary: "#abdbe3", // secondary color - can be used for hover states
